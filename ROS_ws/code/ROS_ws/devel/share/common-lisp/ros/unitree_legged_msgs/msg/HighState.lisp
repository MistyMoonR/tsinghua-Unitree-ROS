...
(cl:defmethod updownSpeed-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unitree_legged_msgs-msg:updownSpeed-val is deprecated.  Use unitree_legged_msgs-msg:updownSpeed instead.")
  (updownSpeed m))

(cl:ensure-generic-function 'forwardPosition-val :lambda-list '(m))
(cl:defmethod forwardPosition-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unitree_legged_msgs-msg:forwardPosition-val is deprecated.  Use unitree_legged_msgs-msg:forwardPosition instead.")
  (forwardPosition m))

(cl:ensure-generic-function 'sidePosition-val :lambda-list '(m))
(cl:defmethod sidePosition-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unitree_legged_msgs-msg:sidePosition-val is deprecated.  Use unitree_legged_msgs-msg:sidePosition instead.")
  (sidePosition m))
...
(cl:defmethod jointP-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unitree_legged_msgs-msg:jointP-val is deprecated.  Use unitree_legged_msgs-msg:jointP instead.")
  (jointP m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HighState>)))
  ...
  "a12e8b22df896c82203810ec6d521dad")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HighState)))
  "Returns md5sum for a message object of type 'HighState"
  "a12e8b22df896c82203810ec6d521dad")
